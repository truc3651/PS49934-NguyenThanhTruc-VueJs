...
const items = [
  ...
  },
  {
    ...
    content: 'Một số loại gia vị cung cấp nhiều polyphenol, chống oxy hóa cao hơn các loại gia vị quen thuộc khác. Với một lượng nhỏ các món ăn đã thêm',
    image: img2,
  },
  {
    title: '9 loại đậu bổ dưỡng nên dùng nhiều',
    content: 'Đậu lăng, đậu nành, đậu phộng, đậu Hà Lan giàu chất xơ, protein cùng nhiều vitamin và khoáng chất, giúp giảm lượng đường máu',
    image: img3,
  },
];
</script>
